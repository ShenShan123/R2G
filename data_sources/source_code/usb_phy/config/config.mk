...
export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/usb_phy.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/timescale.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/usb_rx_phy.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/usb_tx_phy.v
