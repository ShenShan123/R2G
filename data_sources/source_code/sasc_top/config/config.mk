export DESIGN_NAME = sasc_top
export PLATFORM    = nangate45

export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/sasc_top.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/sasc_brg.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/sasc_fifo4.v \
