...
export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_enh_top.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/generic_dpram.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/generic_spram.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/timescale.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_clkgen.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_colproc.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_csm_pb.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_cur_cregs.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_curproc.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_defines.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_fifo.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_fifo_dc.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_pgen.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_tgen.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_vtim.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_wb_master.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/vga_wb_slave.v
