export DESIGN_NAME = wb_dma_top
export PLATFORM    = nangate45

export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_top.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_ch_arb.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_ch_pri_enc.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_ch_rf.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_ch_sel.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_de.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_defines.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_inc30r.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_pri_enc_sub.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_rf.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_wb_if.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_wb_mast.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/wb_dma_wb_slv.v
