...
export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/des.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/desround.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/key_gen.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s1.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s2.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s3.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s4.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s5.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s6.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s7.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/s8.v
