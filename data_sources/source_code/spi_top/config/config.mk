...
export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/spi_top.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/spi_clgen.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/spi_defines.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/spi_shift.v \
