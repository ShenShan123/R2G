export DESIGN_NAME = tv80s
export PLATFORM    = nangate45

export VERILOG_FILES = $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/tv80s.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/tv80_alu.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/tv80_core.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/tv80_mcode.v \
                       $(DESIGN_HOME)/src/$(DESIGN_NAME)/rtl/tv80_reg.v
