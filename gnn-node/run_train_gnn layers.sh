...
# R2G: GNN Layers Ablation Experiment Script
# ================================================
# Purpose: Compare impact of GNN message passing depth (3-6 layers) on performance
# Models: GINE, ResGatedGCN
# Dataset: route_B_homograph, place_B_homograph
#
# Paper correspondence: Table 4-5 (Placement/Routing GNN Layers Ablation)
# ================================================
...
# Maximum window index (loop 1..MAX_WINDOWS). 8 experiments (2 models × 4 GNN layers)
MAX_WINDOWS=${MAX_WINDOWS:-8}

###############################################
# Switch section: 1=enable, 0=disable
# 8 experiments: 2 models × 4 GNN layers
###############################################
...
# GINE on route_B - different GNN layers (3-6 layers, fixed head=3)
MODEL_1="gine"
...
# ResGatedGCN on route_B - different GNN layers (3-6 layers, fixed head=3)
MODEL_5="resgatedgcn"
...
echo "✅ GNN layers ablation experiment tmux session '$SESSION_NAME' created"
