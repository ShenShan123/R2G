...
# R2G: GNN Layers Ablation Study Script
# ================================================
# Purpose: Compare GNN message passing depth (3-6 layers) impact on performance
# Models: GINE, ResGatedGCN
# Dataset: route_E_homograph
#
# Paper Reference: Table 4-5 (Placement/Routing GNN Layers Ablation)
# ================================================
...
# Session name
SESSION_NAME="${SESSION_NAME:-gnn_ablation_layers}"
...
# Maximum window index (loop 1..MAX_WINDOWS). 8 experiments (2 models x 4 GNN layers)
MAX_WINDOWS=${MAX_WINDOWS:-8}

###############################################
# Toggle switches: 1=enable, 0=disable
# 8 experiments: 2 models x 4 GNN layers
###############################################
ENABLE_1=1  # GINE, gnn_layers=3
ENABLE_2=1  # GINE, gnn_layers=4
ENABLE_3=1  # GINE, gnn_layers=5
ENABLE_4=1  # GINE, gnn_layers=6
ENABLE_5=1  # ResGatedGCN, gnn_layers=3
ENABLE_6=1  # ResGatedGCN, gnn_layers=4
ENABLE_7=1  # ResGatedGCN, gnn_layers=5
ENABLE_8=1  # ResGatedGCN, gnn_layers=6

###############################################
# Experiment configuration: GNN layers ablation (3, 4, 5, 6 layers)
# Models: GINE, ResGatedGCN
# Dataset: route_E_homograph
###############################################

# GINE on route_E - Different GNN layers (3-6 layers, fixed head=3)
MODEL_1="gine"
...
# ResGatedGCN on route_E - Different GNN layers (3-6 layers, fixed head=3)
MODEL_5="resgatedgcn"
...
echo "GNN layers ablation study tmux session '$SESSION_NAME' created successfully"
...
echo "  - GNN layers ablation: 3, 4, 5, 6 layers"
echo "  - Fixed head layers: 3 layers"
