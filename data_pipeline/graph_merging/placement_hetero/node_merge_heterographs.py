...
def load_heterograph_files(input_dir: str) -> List[Tuple[str, HeteroData]]:
    ...
    heterograph_files = [f for f in pt_files if f.endswith('_heterograph.pt')]
    ...
    for file_path in sorted(heterograph_files):
        try:
            ...
            # Extract design name (remove _heterograph.pt suffix)
            design_name = os.path.basename(file_path).replace('_heterograph.pt', '')
...
def main():
    ...
    # Configure paths
    input_dir = "/Users/david/Desktop/place1.2/B_graph/batch_output"
    output_path = "/Users/david/Desktop/place1.2/B_graph/place_B_heterograph.pt"
